...
namespace lab7_MVC_EFCore.Data
{
    public partial class MVC_NIIE_LabContext : DbContext
    {
        public MVC_NIIE_LabContext()
        {
        }

        public MVC_NIIE_LabContext(DbContextOptions<MVC_NIIE_LabContext> options)
            : base(options)
        {
        }
